    ...
    public class EntityBaseData<T> : IData<T> where T : ModelBase
    {
        ...
        public DataResult DeleteBykey(int id)
        {
            try
            {
                ...
                if (aModel == null)
                    return new DataResult(false, "Silenecek veri bulunamadı.");
            ...
            catch (Exception exp)
            {
                ...
                return new DataResult(false, exp.Message + exp.InnerException == null ? "" : "(" + exp.InnerException + ")");
            }
        }
        ...
        public List<T> GetByPage(int pageNumber, int pageCount, string orderBy, bool isDesc = false)
        {
            try
            {
                return isDesc
        ...
        public DataResult Insert(T t)
        {
            try
            {
                ...
                _context.SaveChanges();
                return new DataResult(true, "Veri Eklendi!");
        ...
        public DataResult Update(T t)
        {
            try
            {
                ...
                if (aModel == null)
                    return new DataResult(false, "Güncelleme yapılacak veri bulunamadı.");
            ...
            catch (Exception ext)
            {
                ...
                return new DataResult(false, ext.Message + ext.InnerException == null ? "" : "(" + ext.InnerException + ")");
